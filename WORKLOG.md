...
- **Quality Gates:** `tsc --noEmit` 0 ошибок, `eslint src/` 0 errors / 3 warnings, `vitest` **115/115** (+11 новых в `tests/game/colors.test.ts`), регрессия боя 54/54, replay 6/6, обучение 20/20 и 18/18, сборка OK. Коммит `3306020`.
