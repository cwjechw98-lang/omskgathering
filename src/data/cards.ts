...
export const ALL_CARDS: CardData[] = [
  ...
  },
  {
    ...
    rarity: 'common',
    imageUrl: img(
      'magical sentient coffee machine golem in computer lab cluster, steam and magic, school 21',
      105
    ),
  },
  {
  ...
  },
  {
    ...
    rarity: 'common',
    imageUrl: img(
      'young programmer wizard at computer terminal, school 21 ecole, blue code magic flowing from screen',
      110
    ),
  },
  {
    ...
    attack: 1,
    health: 3,
    description: 'Бдительность. При входе — восстановите 1 здоровье.',
  ...
  },
  {
    ...
    rarity: 'rare',
    imageUrl: img(
      'magical school building guardian golem, all-seeing eye, school 21 bocal administration, protective aura',
      116
    ),
  },
  {
    ...
    flavor: '«Собрать. Усилить. Разрушить.»',
    emoji: '⚙️',
  ...
  },
  {
    ...
    flavor: '«Одна команда стирания — и нет проблем.»',
    emoji: '🕳️',
    keywords: [],
    rarity: 'mythic',
    imageUrl: img(
  ...
  },
  {
    ...
    attack: 6,
    health: 6,
    description: 'Растоптать. При входе — восстановите 4 здоровья.',
  ...
  },
  {
    ...
    rarity: 'common',
    imageUrl: img(
      'code review magical magnifying glass revealing secrets, screen with code, school 21 peer review',
      129
    ),
  },
  {
  ...
  },
  {
    ...
    rarity: 'uncommon',
    imageUrl: img(
      'red error terminal destroying code construct, norminette linter fail explosion, school 21',
      134
    ),
  },
  {
    ...
    rarity: 'rare',
    imageUrl: img(
      'terrifying exam paper with skull, school 21 exam rank, both players suffering',
      135
    ),
  },
  {
  ...
  },
  {
    ...
    color: 'white',
    type: 'spell',
    description: 'Восстановите 4 здоровья. Все ваши существа получают +1/+1 навсегда.',
  ...
  },
  {
    ...
    rarity: 'rare',
    imageUrl: img(
      'holy project graph chart glowing with green magic, school 21 holy graph pathway',
      141
    ),
  },
  {
  ...
  },
  {
    ...
    color: 'white',
    type: 'enchantment',
    description: 'Ваши существа получают +1/+0. При гибели вашего существа — восстановите 2 здоровья.',
  ...
  },
  {
    ...
    color: 'white',
    type: 'enchantment',
    description: 'Ваши существа получают +0/+1. В начале хода: если у вас 3+ существ, +2 здоровья.',
