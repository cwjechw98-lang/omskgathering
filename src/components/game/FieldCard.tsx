            ...
            <>
              ...
              <div className="absolute inset-0 pointer-events-none z-30 overflow-hidden">
                <div
                  ...
                  style={{ left: '20%', bottom: '10%', animationDelay: '0ms' }}
                />
                <div
                  className="ice-particle"
                  style={{ left: '50%', bottom: '20%', animationDelay: '200ms' }}
                />
                <div
                  className="ice-particle"
                  style={{ left: '80%', bottom: '15%', animationDelay: '400ms' }}
                />
                <div
                  className="ice-particle"
                  style={{ left: '35%', bottom: '30%', animationDelay: '600ms' }}
                />
                <div
                  className="ice-particle"
                  style={{ left: '65%', bottom: '25%', animationDelay: '800ms' }}
                />
              </div>
            </>
          )}
          ...
          {deathEffect === 'poison' && (
            <div className="absolute inset-0 pointer-events-none z-30 overflow-hidden">
              <div
                ...
                style={{ left: '25%', top: '30%', animationDelay: '0ms' }}
              />
              <div
                className="poison-bubble"
                style={{ left: '55%', top: '45%', animationDelay: '150ms' }}
              />
              <div
                className="poison-bubble"
                style={{ left: '75%', top: '35%', animationDelay: '300ms' }}
              />
              <div
                className="poison-bubble"
                style={{ left: '40%', top: '55%', animationDelay: '450ms' }}
              />
              <div
                className="poison-bubble"
                style={{ left: '65%', top: '50%', animationDelay: '600ms' }}
              />
            </div>
          )}
        </div>
      ...
      >
        ...
        {card.keywords.length > 0 && (
          <div className="flex flex-col gap-0.5 border-t border-gray-700 pt-2">
            {card.keywords.map((k) => (
              <span key={k} className="text-xs text-cyan-300">
                {KW[k] ?? k}
              </span>
            ))}
          </div>
        ...
        {card.data.type === 'creature' && (
          <div className="flex gap-2 mt-2 border-t border-gray-700 pt-2">
            ...
            <span
              className={`text-xs ${hp <= card.maxHealth / 2 ? 'text-red-400' : 'text-green-400'}`}
            >
              ❤️ {hp}/{card.maxHealth}
            </span>
          </div>
