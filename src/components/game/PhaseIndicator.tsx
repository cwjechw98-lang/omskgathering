...
function detectPhase(gameState: GameState, isMyTurn: boolean, playerKey: 'player1' | 'player2'): PhaseId {
...
export function PhaseIndicator({ gameState, isMyTurn, playerKey }: PhaseIndicatorProps) {
  ...
  return (
    <div className="flex items-center gap-1 justify-center" style={{ fontSize: 'clamp(9px, 1vw, 12px)' }}>
